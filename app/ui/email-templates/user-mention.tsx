...
interface EmailTemplateClientViewProps {
  receiverName: string;
  senderName: string;
  projectTitle: string;
...
interface EmailTemplateProjectProps {
  receiverName: string;
  senderName: string;
  project: string;
  projectURL: string;
...
export function EmailTemplateClientView ({
  receiverName,
  projectURL,
  senderName,
  projectTitle,
  projectSubtitle
}: EmailTemplateClientViewProps): JSX.Element {
...
export function EmailTemplateProject ({
    receiverName,
    projectURL,
    senderName,
    project
  }: EmailTemplateProjectProps): JSX.Element {
    const brandColor = "#ff3c00"
    const color = {
      background: "#ffffff",
      text: "#444",
